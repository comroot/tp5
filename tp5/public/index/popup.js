...
function changeVerifyImagePop(){
    ...
    var src = '/Operate/getVerifyImage?mobile='+nowMobile+'&t='+t;
...
function lay_pop(type){
    ...
    if(!reg.test(nowMobile)){
        ...
        layer.open({
            ...
            '<img onclick="javascript:changeVerifyImagePop();" id = "image_code" src="/Operate/getVerifyImage?mobile='+nowMobile+'&t='+t+'">'+
            '</div>'+
       ...
       $(".mobile_text").html("请您填写正确有效的手机号");
        ...
        layui.use('layer', function(){ //独立版的layer无需执行这一句
            ...
            layer.open({
                ...
                '<img onclick="javascript:changeVerifyImage();" id = "image_code" src="/Operate/getVerifyImage?mobile='+nowMobile+'&t='+t+'">'+
                '</div>'+
                '<div class="yanzheng_tishi">'+
                '    <p class="prompt-text image_code_text"><span id="YZ_tishi"></span></p>'+
                '</div>'
